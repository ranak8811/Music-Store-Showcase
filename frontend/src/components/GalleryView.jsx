            ...
            >
              ...
              <div className="p-5 flex-1 flex flex-col justify-between gap-4">
                <div className="flex flex-col gap-2.5">
                  ...
                  {/* Single scrolling active line lyrics block inside Card */}
                  <div className="mt-1 flex flex-col gap-1">
                    <span className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Live Lyrics</span>
                    <div 
                    ...
                    >
                      ...
                      {activeLyricIdx === -1 && <span className="text-slate-600">[Outro/Intro]</span>}
                    </div>
                  </div>
